...
class ImageCropper extends Component {
  ...
  async onConvertImageToEditableSize() {
    const {
      photo: { uri: rawUri, width: imgW, height: imgH },
    } = this.props;
  ...
  render() {
    ...
    const cropWidth = Math.min(xcropWidth, xcropHeight);
            ...
            {!cropMode ? (
              <View style={{ flexDirection: "row" }}>
                ...
                >
                  ...
                  >
                    <Icon style={styles.icon} name="crop" />
                  </TouchableOpacity>
                  {allowRotate && (
                    <View style={{ flexDirection: "row" }}>
                      <TouchableOpacity
                      ...
                      >
                        <Icon style={styles.icon} name="rotate-left-variant" />
                      </TouchableOpacity>
                      <TouchableOpacity
                      ...
                      >
                        <Icon style={styles.icon} name="rotate-right-variant" />
                      </TouchableOpacity>
                    </View>
                  )}
                  {allowFlip && (
              ...
              >
                ...
                >
                  <View style={{ flexDirection: "row" }}>
                    <Icon
                      style={styles.icon}
                      name={!processing ? "check" : "timer-sand"}
                    />
